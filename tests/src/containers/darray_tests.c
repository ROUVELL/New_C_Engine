...
static u8 all_darray_tests_after_create(void) {
    ...
    expect_not_be(arr.data, 0);
    expect_be(0, arr.base.length);
    expect_be(1, arr.base.capacity);
    expect_be(sizeof(u8), arr.base.stride);
    expect_be(0, arr.base.allocator);

    // Push and validate content [69], length = 1, capacity = 1
    darray_u8* returned = darray_u8_push(&arr, 69);
    expect_not_be(arr.data, 0);
    expect_be(1, arr.base.length);
    expect_be(1, arr.base.capacity);
    expect_be(sizeof(u8), arr.base.stride);
    expect_be(0, arr.base.allocator);
    expect_be(&arr, returned);
    expect_be(69, arr.data[0]);

    // Push and validate content [69, 42], length = 2, capacity = 2
    darray_u8_push(&arr, 42);
    expect_not_be(arr.data, 0);
    expect_be(2, arr.base.length);
    expect_be(2, arr.base.capacity);
    expect_be(sizeof(u8), arr.base.stride);
    expect_be(0, arr.base.allocator);
    expect_be(69, arr.data[0]);
    expect_be(42, arr.data[1]);

    // Push and validate content [69, 42, 36], length = 3, capacity = 4
    darray_u8_push(&arr, 36);
    expect_not_be(arr.data, 0);
    expect_be(3, arr.base.length);
    expect_be(4, arr.base.capacity);
    expect_be(sizeof(u8), arr.base.stride);
    expect_be(0, arr.base.allocator);
    expect_be(69, arr.data[0]);
    expect_be(42, arr.data[1]);
    expect_be(36, arr.data[2]);

    // Push and validate content [69, 42, 36, 19], length = 4, capacity = 4
    darray_u8_push(&arr, 19);
    expect_not_be(arr.data, 0);
    expect_be(4, arr.base.length);
    expect_be(4, arr.base.capacity);
    expect_be(sizeof(u8), arr.base.stride);
    expect_be(0, arr.base.allocator);
    expect_be(69, arr.data[0]);
    ...
    expect_be(0, arr.base.allocator);
    expect_be(69, arr.data[0]);
    expect_be(36, arr.data[1]);
    expect_be(19, arr.data[2]);
    expect_be(42, popped_value);
    ...
    expect_be(sizeof(u8), arr.base.stride);
    expect_be(0, arr.base.allocator);
    expect_be(42, arr.data[0]);
    expect_be(69, arr.data[1]);
    ...
    expect_be(true, result);
    expect_not_be(arr.data, 0);
    expect_be(5, arr.base.length);
    expect_be(8, arr.base.capacity);
    expect_be(sizeof(u8), arr.base.stride);
    expect_be(0, arr.base.allocator);
    expect_be(42, arr.data[0]);
    expect_be(69, arr.data[1]);
    expect_be(11, arr.data[2]);
    expect_be(13, arr.data[3]);
    expect_be(17, arr.data[4]);
    ...
    expect_be(0, arr.base.allocator);
    expect_be(69, arr.data[0]);
    expect_be(11, arr.data[1]);
    expect_be(13, arr.data[2]);
    expect_be(17, arr.data[3]);
    ...
    expect_be(0, arr.data);
    expect_be(0, arr.base.length);
    expect_be(0, arr.base.capacity);
    expect_be(0, arr.base.stride);
    expect_be(0, arr.base.allocator);
...
static u8 all_darray_tests_after_reserve_3(void) {
    ...
    expect_be(true, result);
    expect_not_be(arr.data, 0);
    expect_be(7, arr.base.length);
    expect_be(12, arr.base.capacity);
    expect_be(sizeof(u8), arr.base.stride);
    expect_be(0, arr.base.allocator);
    expect_be(42, arr.data[0]);
    expect_be(69, arr.data[1]);
    ...
    expect_be(13, arr.data[3]);
    expect_be(17, arr.data[4]);
    expect_be(21, arr.data[5]);
    expect_be(23, arr.data[6]);
    ...
    expect_be(13, arr.data[2]);
    expect_be(17, arr.data[3]);
    expect_be(21, arr.data[4]);
    expect_be(23, arr.data[5]);
...
static u8 all_darray_tests_after_create_custom_allocator(void) {
    ...
    expect_be(1, arr.base.capacity);
    expect_be(sizeof(u8), arr.base.stride);
    expect_be(&frame_allocator, arr.base.allocator);
...
static u8 darray_string_type_test(void) {
    ...
    expect_be(0, arr.base.length);
    expect_be(1, arr.base.capacity);
    expect_be(sizeof(const char*), arr.base.stride);
    expect_be(0, arr.base.allocator);
    ...
    expect_be(0, arr.base.allocator);
    expect_string("test", arr.data[0]);
    expect_string("something else", arr.data[1]);
    ...
    expect_string("test", arr.data[0]);
    expect_string("something else", arr.data[1]);
    expect_string("ththth", arr.data[2]);
...
static u8 darray_float_type_test(void) {
    ...
    expect_be(0, arr.base.length);
    expect_be(1, arr.base.capacity);
    expect_be(sizeof(f32), arr.base.stride);
    expect_be(0, arr.base.allocator);
